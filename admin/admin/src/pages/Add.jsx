...
function Add() {
  ...
  let [subCatagory,setSubCatagory] = useState("TopWear")
  ...
  const handleAddPRoductFunction = async (e) =>{
    setLoading(true)
    e.preventDefault()
    try{
  ...
  return (
    ...
    <form action="" onSubmit={handleAddPRoductFunction} className='w-[100%] md:w-[90%] h-[100%] mt-[70px] flex flex-col gap-[30px] py-[60px] px-[30px] md:px-[60px]'>
    ...
    <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px]'>
      ...
      <input type='text' placeholder='Type Here' className='w-[600px] max-w-[98%] h-[40%] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]' onChange={(e)=>setName(e.target.value)} value={name} />
    </div>
     ...
     <p className ='text-[20px] md:text-[25px] font-semibold'> 
      ...
      <textarea type='text' placeholder='type here' className='w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] py-[20px] text-[18px] placeholder:text-[#ffffffc2]' onChange={(e)=>setDescription(e.target.value)} value={description}/>
      </div>

      <div className='w-[80%] flex items-center gap-[100px] flex-wrap'>
        <div className='md:w-[30%] w-[100%] flex items-start sm-justify-center flex-col gap-[10px]'>
        <p className='text-[20px] md:text-[25px] font-semibold w-[100%]'>Product-Catagory</p>
        <select name='' id='' className='bg-slate-600 w-[60%] px-[10px] py-[7py] rounded-lg hover:border-[#46d1f7] border-[2px]' onChange={(e)=>setCategory(e.target.value)} value={category}>
        ...
        <div className='md:w-[30%] w-[100%] flex items-start sm-justify-center flex-col gap-[10px]'>
        <p className='text-[20px] md:text-[25px] font-semibold w-[100%]'>Sub-Catagory</p>
        <select name='' id='' className='bg-slate-600 w-[60%] px-[10px] py-[7py] rounded-lg hover:border-[#46d1f7] border-[2px]' onChange={(e)=>setSubCatagory(e.target.value)} value={subCatagory}>
      ...
      <input type='number' placeholder='₹10' className='w-[600px] max-w-[98%] h-[40%] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]'onChange={(e)=>setPrice(e.target.value)} value={price} />
    </div>


    <div className='w-[80%] h-[220px] md:h-[100px] flex items-start flex-col gap-[10px] py-[10px] md:py-[0px]'>
