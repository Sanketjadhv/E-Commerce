  ...
  return (
    ...
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white'>
      ...
      <div className='w-[100%] h-[100%] flex items-center justify-start'>
        <Sidebar/>
        <div className='w-[82%] h-[100%] lg:ml-[320px] md:ml-[230px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[50px]'>
        <div className='w-[400x] h-[50px] text-[28px] md:text-[40px] mb-[20px] text-white'>
        All list product
        </div>
