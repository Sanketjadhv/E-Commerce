...
function Newletterbox() {
  ...
  return (
    ...
    <div className='w-[100%] h-[40vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start gap-[10px] flex-col'>
        ...
        <p className='md:text-[18px] text-[14px] text-[14px] text-center text-blue-100 font-semibold px-[20px]'>Sibscribe now and enjoy exclusive savings, special deals, and early access to new collection.</p>
