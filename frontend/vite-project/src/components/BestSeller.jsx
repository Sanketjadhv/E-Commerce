...
function BestSeller() {
  ...
  let[bestseller, seBestSeller] = useState([])

  useEffect(()=>{
    let filterProduct = products.filter((item)=>item.bestseller)
    seBestSeller(filterProduct.slice(0,4));
  },[products])
  return (
   <>
   <div>
    ...
    <div className='w-[100%] h-[50%] mt-[5%] flex items-center justify-center flex-wrap gap-[50px]'>
      {
